  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:levels:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          icon="Download"
          @click="handleExport"
          v-hasPermi="['system:levels:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="levelsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button link type="primary" icon="Edit" @click="handleUpdate(scope.row)" v-hasPermi="['system:levels:edit']">修改</el-button>
          <el-button link type="primary" icon="Delete" @click="handleDelete(scope.row)" v-hasPermi="['system:levels:remove']">删除</el-button>
        </template>
      </el-table-column>
    </el-table>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="levelsRef" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="保护级别名称" prop="name">
          <el-input v-model="form.name" placeholder="请输入保护级别名称" />
        </el-form-item>
        <el-form-item label="是否有数据" prop="hasData">
...
import { listLevels, getLevels, delLevels, addLevels, updateLevels } from "@/api/system/levels"
...
function handleDelete(row) {
  ...
  proxy.$modal.confirm('是否确认删除relicLevels编号为"' + _ids + '"的数据项？').then(function() {
...
function handleExport() {
  proxy.download('system/levels/export', {
    ...queryParams.value
  }, `levels_${new Date().getTime()}.xlsx`)
}
